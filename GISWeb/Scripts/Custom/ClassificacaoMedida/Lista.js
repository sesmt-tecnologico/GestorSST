...
function DeletarClassificacao(IDclassificacao, Nome) {
    ...
    var callback = function () {
        ...
        $.ajax({
            method: "POST",
            url: "/ClassificacaoMedida/Terminar",
    ...
    ExibirMensagemDeConfirmacaoSimples("Tem certeza que deseja excluir esta Classificação?", "Exclusão de Classificação", callback, "btn-danger");
