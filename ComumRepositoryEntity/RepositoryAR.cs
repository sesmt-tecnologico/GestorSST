...
namespace ComumRepositoryEntity
{
    public abstract class RepositoryAR<TDominio, TChave> : IRepositorioAR<TDominio, TChave> where TDominio : class
    {

        protected DbContext _context;

        public RepositoryAR(DbContext context)
        {
            _context = context;
        }
